...
class NoiseBlock(nn.Module):
    def __init__(self, dim):
        ...
        # rt_snac: gate the stochastic term. Default True reproduces upstream
        # exactly. Set False (via SNAC.set_noise) for a deterministic, ONNX-
        # exportable decoder — the noise term is simply dropped.
